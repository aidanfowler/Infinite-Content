...
- The server files should go on the pi and relies on hzellers rpi rgb matrix library (https://github.com/hzeller/rpi-rgb-led-matrix)
- The client file is what I used for testing before getting the processing code directly connected to the pi with udp (instead of the intial implementation of zmq)
